defmodule Ecto.Adapters.OracleIntegrationTest do
  ...
  defmodule User do
    ...
    # Use IDENTITY column for auto-increment; autogenerate: false allows explicit IDs
    # Note: Full RETURNING INTO support for Ecto autogenerate is pending
    # Use raw SQL with Variable API for true auto-generated ID retrieval (see returning_test.exs)
  ...
  describe "Repo.insert/2" do
    test "inserts a record with explicit ID" do
      # With GENERATED BY DEFAULT AS IDENTITY, explicit IDs are allowed
  ...
  describe "Repo.insert_all/3" do
    test "inserts multiple records without returning" do
      ...
      # With IDENTITY column, Oracle auto-generates IDs when not specified
      entries = [
